...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/admin/locations/create" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Add Location</a>
</div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge <?= $loc['status'] ? 'bg-success' : 'bg-secondary' ?>">
                            <?= $loc['status'] ? 'Active' : 'Hidden' ?>
                        </span>
                    </td>
                    <td class="text-end">
                        <!-- Nút Sửa: btn-sm = nút nhỏ, btn-warning = vàng, fa-edit = icon bút sửa -->
                        <a href="/admin/locations/<?= $loc['id'] ?>/edit" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
