...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/admin/faqs/create" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Add FAQ</a>
</div>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                <?php if (empty($items)): ?>
                    ...
                    <tr><td colspan="6" class="text-center text-muted py-3">No FAQs found.</td></tr>
                <?php else:
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <a href="/admin/faqs/<?= $faq['id'] ?>/edit" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
