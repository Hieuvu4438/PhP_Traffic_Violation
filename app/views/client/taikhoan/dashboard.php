...
<div class="container py-4">
    <h2 class="fw-bold mb-4">
        ...
        <i class="fas fa-tachometer-alt me-2 text-primary"></i>My Account
    </h2>
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0 bg-primary bg-opacity-10">
                <div class="card-body">
                    ...
                    <h4 class="mb-1">Hello, <?= htmlspecialchars(Session::get('user_name'), ENT_QUOTES, 'UTF-8') ?>!</h4>
                    <p class="text-muted mb-0">Welcome to your account management page.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 text-center h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">Registered Vehicles</p>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 text-center h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">Personal Information</p>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-info text-white fw-bold">
                    <i class="fas fa-history me-2"></i>Recent Search History
                </div>
                <!-- p-0: không padding để bảng sát viền -->
                <div class="card-body p-0">
                    <?php if (empty($recentHistory)): ?>
                        <div class="text-center py-4 text-muted">
                            <p class="mb-0">You haven't performed any searches yet.</p>
                            <a href="/tra-cuu" class="btn btn-outline-primary btn-sm mt-2">Search Now</a>
                        </div>
                    <?php else: ?>
